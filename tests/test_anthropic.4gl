...
MAIN
    ...
    VAR mycallback aim_anthropic.t_tool_function_dispatcher = FUNCTION exec_tools
    CALL request.set_system_message("You are a Math teacher.")
    LET x = request.append_user_message("Use the provided tools to generate the result for a user question.")

    VAR tps1 aim_anthropic.t_tool_signature_params = [
    ...
    VAR tps2 aim_anthropic.t_tool_signature_params = [
    ...
    VAR tps3 aim_anthropic.t_tool_signature_params = [
